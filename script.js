...
navContainerEl.addEventListener("mouseover", (e) => {
  if (e.target.classList.contains("nav-btn")) {
    underline = RoughNotation.annotate(e.target, {
      type: "underline",
      color: "#FB2576",
    });
    underline.show();
...
headings.forEach((heading) => {
  const annotation = RoughNotation.annotate(heading, {
    type: "underline",
    color: "#FB2576",
  });
  annotation.show();
...
skills.forEach((skill) => {
  ...
  <div class="col s3">
      <div class="skill">
        <img src="images/${skill.url}" alt="${skill.name}" />
      </div>
  </div>
  `;
  skillsContainer.insertAdjacentHTML("beforeend", output);
});
    ...
    <div class="project" >
        <div class="project-img">
          ...
          <div class="project-links">
              ...
              <a href="${
                project.github
              }" class="view-github" title='view on github'><i class="fa-brands fa-github"></i></a>
          </div>
